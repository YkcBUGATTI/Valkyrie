# -*- coding: utf-8 -*-
"""Valkyrie media library downloader v2 - curl transport (30 targets).
...
TARGETS = os.path.join(BASE, "assets", "_target30.json")
IMGDIR  = os.path.join(BASE, "img")
LOG     = os.path.join(BASE, "assets", "_dl30_log.json")
...
def main():
    ...
    with open(TARGETS, encoding="utf-8") as f:
        targets = json.load(f)
    order = {"r1": 1, "r2": 2, "r3": 3, "r4": 4, "r5": 5, "r6": 6, "r7": 7}
